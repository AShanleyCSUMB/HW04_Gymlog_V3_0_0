...
public class MainActivity extends AppCompatActivity {
    ...
    static final String SAVED_INSTANCE_STATE_USERID_KEY = "SHARED_PREFERENCE_USERID_KEY";
    ...
    private void loginUser(Bundle savedInstanceState) {
        ...
        //check shared preference for logged in users
        
        SharedPreferences sharedPreferences = getSharedPreferences(getString(R.string.preference_file_key), Context.MODE_PRIVATE);

        loggedInUserId = sharedPreferences.getInt(getString(R.string.preference_file_key), LOGGED_OUT);
    ...
    private void getInformationFromDisplay() {
        ...
        mWeight = Double.parseDouble(binding.weightInputText.getText().toString());
            ...
            Log.d(TAG, "Error reading value from weightInputText");
        }
        try {
            mReps = Integer.parseInt(binding.repInputText.getText().toString());
        } catch(NumberFormatException e){
            Log.d(TAG, "Error reading value from repInputText");
        }
    }
}
